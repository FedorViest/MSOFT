...
route_1 = SavedRoute("Belusa", "Beckov", 20, 3, ["bike", "bunjee-jumping", "walk"], ["campsite 1", "campsite 2"],
                     None, datetime.datetime.now())
route_2 = SavedRoute("Podbanske (Kokavsky most)", "Pribilina", 50, 8, ["rollerskates", "swim", "rock-climb"],
                     ["hotel 1", "hotel 2"], None, datetime.datetime.now())
my_routes = [route_1, route_2]


shared_route_1 = Route("Belusa", "Beckov", 20, 3, ["bike", "bunjee-jumping", "walk"], ["campsite 1", "campsite 2"],
                     None)
shared_route_2 = Route("Podbanske (Kokavsky most)", "Pribilina", 50, 8, ["rollerskates", "swim", "rock-climb"],
